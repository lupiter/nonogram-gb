...
#include <assets/background/title_assets.h>
...
void init_title(void) {
    ...
    set_bkg_tiles(0, 0, title_assets_WIDTH / title_assets_TILE_W, title_assets_HEIGHT / title_assets_TILE_H, title_assets_map);
